class PurchaseAddress
  ...
  with_options presence: true do
    ...
    validates :postal_code,
              format: { with: /\A[0-9]{3}-[0-9]{4}\z/, message: 'が正しくありません。次のように入力してください。 (例： 123-4567)' }
  ...
  def save
    ...
    Address.create(postal_code: postal_code, shipping_area_id: shipping_area_id, municipality: municipality,
